				...
				<?php
					...
					while($row = mysqli_fetch_assoc($query_run)){
						...
						<tr>
							...
							<td>
								<button class="btn" name=""><a class="btn btn-primary" href="edit_book.php?bn=<?php echo $row['book_no'];?>">Edit</a></button>		||
								<button class="btn" name=""><a class="btn btn-danger" href="delete_book.php?bn=<?php echo $row['book_no'];?>">Delete</a></button>
							</td>
						</tr>
						<?php
					}
