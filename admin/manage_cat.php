				...
				<?php
					...
					while($row = mysqli_fetch_assoc($query_run)){
						...
						<tr>
							...
							<td>
								<button class="btn" name=""><a class="btn btn-primary" href="edit_cat.php?cid=<?php echo $row['cat_id'];?>">Edit</a></button>
								||
								<button class="btn" name=""><a class="btn btn-danger" href="delete_cat.php?cid=<?php echo $row['cat_id'];?>">Delete</a></button>
							</td>
						</tr>
						<?php
					}
