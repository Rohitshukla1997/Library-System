	...
	<div class="col-md-8">
		<form>
			<table class="table-bordered" width="900px" style="text-align: center">
				<tr>	
					<th><h5>Name</h5><br></th>
					<th><h5>Author</h5><br></th>
					<th><h5>Number</h5><br></th>
					<th><h5>Student Name</h5><br></th>
				...
				?>
						<tr>
							...
							<td><button class="btn" name=""><a class="btn btn-danger" href="delete_issued.php?bn=<?php echo $row['book_no'];?>">Delete</a></button>
							</td>
						</tr>
						<?php
					}
